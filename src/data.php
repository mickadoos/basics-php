...
$mealsData = [
    ...
    ['name' => "Vegetable Soup", 'cookingTime' => 45, 'calories' => 200, 'difficulty' => "Easy"],
...
$productsData = [
    ...
    ['name' => "Smartphone", 'price' => 699.99, 'stock' => 100, 'category' => "Electronics"],
    ['name' => "Desk Chair", 'price' => 149.99, 'stock' => 75, 'category' => "Furniture"]
];